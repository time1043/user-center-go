...
type RealWorldHTTPServer interface {
	// AddComment Add comment to an article
	...
	// DeleteComment Delete comment from an article
	...
	// GetComments Get comments from an article
...
func (c *RealWorldHTTPClientImpl) DeleteArticle(ctx context.Context, in *DeleteArticleRequest, opts ...http.CallOption) (*EmptyReply, error) {
	var out EmptyReply
...
func (c *RealWorldHTTPClientImpl) DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...http.CallOption) (*EmptyReply, error) {
	var out EmptyReply
